...
![Joomla!](https://img.shields.io/badge/Joomla!-3.7_и_4-1A3867.svg?style=for-the-badge)
![Php](https://img.shields.io/badge/php-5.6+-8892BF.svg?style=for-the-badge)

**ВАЖНО!** Официальний релиз 1.8.9 является финальным, дальнейшее сопровождение данного расширения не планируется.

**Даный форк являэтся не официальним и имеет ограниченую поддержку.**
